...
var options1 = {
	series: [{
		...
		name: 'Split',
		data: [51, 62, 55, 52, 14, 45, 15]
	}, {
		name: 'Air Cooler',
		data: [11, 52, 50, 52, 14, 45, 15]
	}, {
		name: 'Air Purifier',
		data: [11, 14, 82, 72, 4, 5, 45]
	}],
	...
	xaxis: {
		categories: ["June", "July", "Augest", "September", "October", "November", "December"]
	},
	tooltip: {
		x: {
			format: 'dd/MM/yy'
...
var options3 = {
	...
	xaxis: {
		categories: ['Delhi', 'Kanpur', 'Nodia', 'Kolkata', 'Gurgoan'],		
	},
	yaxis: {
		title: {
			text: undefined
...
var options5 = {
	...
	labels: ['Present', 'Leave', 'LWP', 'Week Off', 'I am Sate'],
	legend: {
		show: true,
	},
	hover: {mode: null},
